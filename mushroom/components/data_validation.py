...
from mushroom.exception import SrcException
...
class DataValidation:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            base_df = utils.convert_columns_string(df=base_df, exclude_columns=exclude_columns)
            train_df = utils.convert_columns_string(df=train_df, exclude_columns=exclude_columns)
            test_df = utils.convert_columns_string(df=test_df, exclude_columns=exclude_columns)
